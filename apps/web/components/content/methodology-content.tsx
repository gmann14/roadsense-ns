    ...
    <section style={{ display: "grid", gap: 18 }}>
      <div className="card" style={{ padding: 24, display: "grid", gap: 10 }}>
        ...
        <p className="lede" style={{ margin: 0 }}>
          Every published pixel on this map ties back to a real drive, a specific road, and a recompute
      ...
      <article id="aggregation" className="card" style={{ padding: 24, display: "grid", gap: 12 }}>
        ...
        <p className="lede" style={{ margin: 0 }}>
          ...
          matches each drive sample to a road and turns repeated passes into public confidence tiers.
        </p>
        <div className="drawer-callout">
          ...
          <span className="lede">
            Moving the match server-side keeps the road scoring consistent across app versions, and makes it easy
