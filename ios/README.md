...
- The app target now supports deterministic large-text simulator runs via `ROAD_SENSE_DYNAMIC_TYPE_SIZE`, and UI tests cover privacy-zone management plus stats/settings usability at `accessibility5`.
