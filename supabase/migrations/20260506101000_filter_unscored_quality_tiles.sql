-- Keep the quality map visually honest: only publish roughness-colored road
-- segments that have at least one reading. The public stats MV already uses
-- this rule for map_bounds; this migration brings the vector tile layer into
-- alignment so untracked/default aggregate rows do not appear as scored roads.
