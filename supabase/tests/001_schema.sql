...
SELECT has_type('public', 'pothole_action_type', 'pothole_action_type enum exists');
...
SELECT has_table('public', 'pothole_actions', 'pothole_actions table exists');
...
SELECT col_type_is('public', 'pothole_actions', 'device_token_hash', 'bytea', 'pothole_actions.device_token_hash is bytea');
...
SELECT has_index('public', 'pothole_actions', 'idx_pothole_actions_geom', 'pothole_actions geom index exists');
SELECT has_index('public', 'pothole_actions', 'idx_pothole_actions_report', 'pothole_actions report index exists');
