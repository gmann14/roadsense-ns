...
SELECT is(
    ...
    'smooth',
    'score below 0.3 maps to smooth'
);
...
INSERT INTO readings (
    ...
    ('00000000-0000-0000-0000-000000000903', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000602', decode('03', 'hex'), 0.90, 50.0, 90.0, 5.0, TRUE, 2.10, ST_GeomFromText('POINT(-63.5692 44.6520)', 4326), '2026-04-18T14:02:00Z'::TIMESTAMPTZ),
    ('00000000-0000-0000-0000-000000000904', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000602', decode('04', 'hex'), 0.90, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5691 44.6520)', 4326), '2026-04-18T14:03:00Z'::TIMESTAMPTZ),
    ('00000000-0000-0000-0000-000000000905', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000602', decode('05', 'hex'), 0.90, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5690 44.6520)', 4326), '2026-04-18T14:04:00Z'::TIMESTAMPTZ);
...
SELECT is(
    (SELECT roughness_category::TEXT FROM segment_aggregates WHERE segment_id = '00000000-0000-0000-0000-000000000801'),
    'rough',
    'score between 0.6 and 1.0 maps to rough'
);
...
INSERT INTO readings (
    ...
    ('00000000-0000-0000-0000-000000000906', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000603', decode('06', 'hex'), 1.50, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5689 44.6520)', 4326), '2026-04-18T14:05:00Z'::TIMESTAMPTZ),
    ('00000000-0000-0000-0000-000000000907', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000603', decode('07', 'hex'), 1.50, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5688 44.6520)', 4326), '2026-04-18T14:06:00Z'::TIMESTAMPTZ),
    ('00000000-0000-0000-0000-000000000908', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000603', decode('08', 'hex'), 1.50, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5687 44.6520)', 4326), '2026-04-18T14:07:00Z'::TIMESTAMPTZ),
    ('00000000-0000-0000-0000-000000000909', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000603', decode('09', 'hex'), 1.50, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5686 44.6520)', 4326), '2026-04-18T14:08:00Z'::TIMESTAMPTZ),
    ('00000000-0000-0000-0000-00000000090a', '00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000603', decode('0a', 'hex'), 1.50, 50.0, 90.0, 5.0, FALSE, NULL, ST_GeomFromText('POINT(-63.5685 44.6520)', 4326), '2026-04-18T14:09:00Z'::TIMESTAMPTZ);
...
SELECT is(
    (SELECT roughness_category::TEXT FROM segment_aggregates WHERE segment_id = '00000000-0000-0000-0000-000000000801'),
    'very_rough',
    'score at or above 1.0 maps to very_rough'
);
